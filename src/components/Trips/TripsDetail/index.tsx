      ...
      <div className=" bg-white rounded-lg ">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">
              After breakfast as a group, the day is yours to do as you wish.
              There will be the option to join a local guide to show us around
              the Historic Medina which can be like walking around a labyrinth
              with its narrow streets, bustling souks (markets), and, of course,
              find a shop to buy your obligatory traditional hat of Morocco, The
              Red Fez (Tommy Cooper). You are welcome to do your own thing after
              the guided tour, or you are welcome to spend the whole day as you
              wish. Our hotel accommodation will be @ same hotel as our previous
              night.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">
              After breakfast at the hotel, we set off for a day of real
              adventure traveling south, climbing towards the plateau of The
              Middle Atlas, stopping for a drink break and a photo opportunity.
              Then pushing on southwest, cutting over The High Atlas themselves,
              before passing through the stunning Gorge de Ziz. Finally, we will
              arrive at our overnight stop @ Ighiz Inn Resort Errachidia.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">
              ...
              over to tackle the snaking passes of Valley Du Dades. Later, we
              will be heading to our overnight accommodation in Ouarzazate,
          ...
          <section className="mt-12">
            ...
            <p className="text-gray-700 mt-2">
              ...
              abilities. There will be a support vehicle traveling with us at
              all times, with a box trailer to carry your luggage.
            </p>
            ...
            <p className="text-gray-700 mt-2">
              ...
              <ul className="list-disc pl-5 mt-2 text-gray-700">
                <li>
                  Crossings from Portsmouth to Spain with a cabin & your return
                </li>
            ...
            <p className="text-gray-700 mt-2">
              ...
              <ul className="list-disc pl-5 mt-2 text-gray-700">
                ...
                <li>Breakdown insurance covering repatriation back to UK</li>
                <li>
                  Motorcycle Insurance (you will need to purchase third party
                  insurance at Moroccan border)
                </li>
            ...
            <p className="mt-6 text-center">
              <a
                ...
                target="_blank"
                className="bg-primary text-white px-8 py-3 rounded-lg hover:bg-indigo-700 transition duration-300"
              >
                Book Your Place
              </a>
            </p>
