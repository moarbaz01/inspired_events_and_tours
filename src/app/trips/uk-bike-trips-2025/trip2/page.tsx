    ...
    <div className="py-8 px-4 sm:px-6 lg:px-8  min-h-screen">
      <div className=" p-6">
        ...
        <p className="text-lg text-center text-gray-600 mb-8">
          <strong>Date:</strong> June 21st 2025 - June 26th 2025
        </p>
        ...
        <div className="space-y-8">
          <section>
            <p className="text-gray-700 mt-2">
              FULLY BOOKED SEE JUY 13TH TRIP FOR SPACES After the amazing
              success of these trips in 2022/2023 @ 2024 we are excited to be
          ...
          <section>
            <p className="text-gray-700 mt-2">
              TRIP FULLY BOOKED SPACE AVAILABLE ON JULY 13TH TRIP
            </p>
          </section>
        </div>
      </div>
