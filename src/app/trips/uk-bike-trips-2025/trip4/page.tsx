    ...
    <div className="py-8 px-4 sm:px-6 lg:px-8  min-h-screen">
      <div className=" p-6">
        ...
        <p className="text-lg text-center text-gray-600 mb-8">
          <strong>Date:</strong> September 7th 2025 - September 18th 2025
        </p>
        ...
        <div className="space-y-8">
          <section>
            <p className="text-gray-700 mt-2">
              After the amazing success of these trips in 2022/2023 @ 2024 we
              are excited to be returning for 2025 and give you something
              positive to look forward to.
            </p>
            <p className="text-gray-700 mt-2">
              Due to the nature of much of the roads and tracks along the NC500
          ...
          <section>
            <p className="text-gray-700 mt-2">
              Below are the campsites we will be stopping at, all have showers
              and toilets, and hot food available at all but the inverness site,
              but there are shops and takeaways nearby
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">
              ...
              separate ways home on Thursday If you would like to be part of
              this epic motorbike road trip the cost per bike including a
              pillion is just £349 this covers all your camping fees the tent
              hire and bed and chairs., if you have other people on their own
              bikes that wish to go with you please message me to discuss.. We
              also give you a printed information sheet for each day and your
              own NC500 Guide book.
            </p>
          </section>
          <section>
            <p className="text-gray-700 mt-2">
