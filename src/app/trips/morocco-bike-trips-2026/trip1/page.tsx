    ...
    <div >
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="text-gray-700 mt-2">
            ...
            past that many new friendships will be formed. We will arrive back
            in Portsmouth at around 9pm on the 26th.
          </p>
        </section>
      </div>
      ...
      <section className="mt-12">
        ...
        <p className="text-gray-700 mt-2">
          ...
          heavy bike each day. The cost of this trip is £1889 per bike without a
          pillion and is based on sharing twin rooms at each booked hotel. If
          you wish to have your own room or travel with a pillion then please
          contact us to discuss further. The price includes the following
        </p>
