    ...
    <div>
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="text-gray-700 mt-2">
            OOur final day together sees us onboard or Brittany Ferry crossing.
            ...
            in Portsmouth at around 9pm on the 25TH. of November.
          </p>
        </section>
      </div>
      ...
      <section className="mt-12">
        ...
        <p className="text-gray-700 mt-2">
          ...
          to get the most out of this trip, but having said that this trip can
          be completed on any motorcycle if you feel happy enough in your own
          abilities. There is a support vehicle traveling with us at all times
          with a box trailer that can carry your luggage etc from Portsmouth,
          and then once on trip we will carry it every day between hotels
          allowing you to ride with the freedom of not having a fully loaded
          heavy bike each day. The cost of this trip is <b>£1889</b> per bike
          without a pillion and is based on sharing twin rooms at each booked
          hotel. If you wish to have your own room or travel with a pillion then
          please contact us to discuss further. The price includes the following
        </p>
        ...
        <p className="text-md font-semibold text-gray-800 mt-4">
          ...
          card using the secure link below . Places are limited to 20 and demand
