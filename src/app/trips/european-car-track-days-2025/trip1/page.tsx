    ...
    <div>
      ...
      <div className="space-y-8">
        ...
        <section>
          <p className="text-gray-700 mt-2">
            ...
            our overnight stay in Soissons. Which is about a 3hr drive depending
            on speeds. From experience most drivers want to make their own way
            to Soissons rather than follow the support vehicle. Little boring at
          ...
          <p className="text-gray-700 mt-2">
            ...
            never more than 15 cars on track at any one time. And being a fairly
            long track, it means you will not be bunched up or feel intimidated.
            And the best thing about the track day is its an open pit meaning
            you can go out as often as you like. Not like many track days.
          </p>
        </section>
        ...
        <section>
          <p className="text-gray-700 mt-2">
            Some of the things that that this track day offers . A professional
            photographer will be at the track who will be taking pictures of
            everyone all day , and upload them to a website a few days after the
            trip so you can download as many pictures as you wish. Full public
            liability insurance, circuit marshals and a medical team on standby
            at the circuit.
          </p>
        </section>
      ...
      <section className="mt-12">
        ...
        <p className="text-md font-semibold text-gray-800 mt-4">
          Place can be reserved with a £149 deposit. Simply click on the link to
          reserve your place.
        </p>
