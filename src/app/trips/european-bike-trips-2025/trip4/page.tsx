    ...
    <div className="py-8 px-4 sm:px-6 lg:px-8  min-h-screen">
      <div className=" p-6">
        ...
        <p className="text-lg text-center text-gray-600 mb-8">
          <strong>Date:</strong> 18th August 2025 - 25th August 2025
        </p>
        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-gray-700 mt-2">
              Our tour starts with us meeting in Folkestone at around 9am on the
              first day of your chosen trip. The meeting point is the Premier
              Inn To catch the 11.20 EuroTunnel to Calais.From experience from
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">
              ...
              our second night’s stop near Baden Baden @ Badischer Hof Hotel, we
              rest up and get ready for the first famous part of the road trip
              in the shape of the B500, this stretch of tarmac has long been
              coveted by car drivers looking for long sweeping roads that run
              from bend to bend. Sure not to disappoint, it will have you
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">
              ...
              to our base for 2 nights near the historic town of Zell am
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">
              ...
              our second night at the hotel Gasthof Geronimo Hotel.
            </p>
          </section>
          <section>
            <h2 className="text-2xl font-bold text-primary">
              Day 5. Zell Am See(Switzerland)-Davos(Switzerland) Approximately
              200 Miles
            </h2>
            <p className="text-gray-700 mt-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-primary">
              Day 6 Davos(Switzerland) - Belfort (France) Approximately 200
              Miles
            </h2>
            <p className="text-gray-700 mt-2">
              From here we head for the Alpe Di Sorecia to take on the world
              famous Gotthard pass with its famous cobbled hairpins, get in
              touch with your inner 007 on the nearby Furka pass immortalized by
              the car chase in Goldfinger then drive the giddy heights of the
              Grimsel pass at an elevation of 7,100 feet and the Nufenen at
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">
              ...
              Please understand that this is a real drivers trip with some long
          ...
          <section>
            <p className="text-gray-700 mt-2">
              ...
              time at certain places, or have other places and places of
              interest they wish to visit. We are on hand everyday to give
              guidance and advice. But each day you will travel between hotels
              at a pace and route that suits you and we will regroup at the
              evenings hotel and share stories of the day&apos;s journey. Please be
              aware that the daily approximate mileage is based on riding the
              most direct route.
            </p>
            <p className="text-gray-700 mt-2">
              And will change depending on the route you ride between A to B.
              The price per bike and includes a pillion is £1389 with your
              crossing both ways by Eurotunnel and the 7 nights hotel
              accommodation. Your accommodation will be double room to yourself
              unless traveling with a pillion, and includes breakfast evening
              food is not included but is available at the hotels or nearby
              restaurants.. A deposit of £389 is required to book your place
              with the balance due 8 weeks prior to the trip
            </p>
          </section>
          ...
          <section>
            ...
            <a
              href="https://buy.stripe.com/fZefZffBIgTi4fKcNU"
