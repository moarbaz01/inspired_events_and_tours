    ...
    <div className="py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 min-h-screen">
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <p className="text-lg text-center text-gray-600 mb-8">
          <strong>Date:</strong> 17th September 2025 - 19th September 2025
        </p>
        ...
        <div className="space-y-8">
          <section>
            <p className="text-gray-700 mt-2">
              We all meet at Folkestone at 11.30 am on September 17th and sort
              out all the tickets and paperwork ready to board the 1.20 train to
          ...
          <section>
            <p className="text-gray-700 mt-2">
              ...
              card. Please let me know your thoughts Regards Ada
            </p>
          </section>
          ...
          <section>
            <p className="text-sm font-bold">
              Place can be reserved with a £149 deposit Simply click this link
              to pay your deposit
            </p>
            <a
              href="https://buy.stripe.com/6oEaEVdtA46weUo8xk"
