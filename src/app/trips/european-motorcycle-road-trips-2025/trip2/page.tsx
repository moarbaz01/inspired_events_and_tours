      ...
      <div className="space-y-8">
        <section>
          ...
          <p className="text-gray-700 mt-2">
            ...
            To catch the 11.20 EuroTunnel to Calais.From experience from
        ...
        <section>
          ...
          <p className="text-gray-700 mt-2">
            ...
            is available at the hotels or nearby restaurants.. A deposit of £389
            is required to book your place with the balance due 8 weeks prior to
            the trip
          </p>
        </section>
