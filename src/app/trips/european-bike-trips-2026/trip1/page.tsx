        ...
        <div className="space-y-8">
          <section>
            <p className="text-gray-700 mt-2">
              ...
              70mph on a motorway. There are route options to Soisson&apos;s and most
              choose the more exciting route. We give you printed out map
              instructions if you need them. Once checked in, the rest of the
              day is your own to spend as you wish, but most people seem to just
              want to relax and have something to eat and a couple of drinks
              before getting an early night ready for the track day. There are a
              selection of restaurant&apos;s within a 5-minute walk. And a great
              Chinese buffet next door to the hotel that offers great food and
              for £20 you get all you can eat and 3 beers. This one seems to be
            ...
            <p className="text-gray-700 mt-2">
              ...
              are never more than 20 bikes on track at any one time. And being a
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">
              The full cost of the trip is just £449 per bike with the rider,
              and your accommodation is based on sharing a twin room. Single
              occupancy rooms available at additional cost of £80 or if
              traveling with a pillion the same additional cost applies. We hope
              you like the sound of this amazing trip and decide to join us. You
              can secure your place with a £149 deposit paid by debit or credit
              card.
            </p>
          </section>
