    ...
    <div className="py-8 px-4 sm:px-6 lg:px-8  min-h-screen">
      <div className=" p-6">
        <h1 className="text-3xl font-semibold text-center text-primary mb-4">
          France Austria & Switzerland Bike Trip
        </h1>
        <p className="text-lg text-center text-gray-600 mb-8">
          <strong>Date:</strong> July 6th 2026 - July 13th 2026
        </p>
        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-gray-700 mt-2">
              ...
              Inn To catch the 11.20 Euro Tunnel to Calais. From experience from
          ...
          <section>
            ...
            <a
              href="https://buy.stripe.com/7sIfZfgFMauUh2w29D"
