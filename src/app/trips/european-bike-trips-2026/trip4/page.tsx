    ...
    <div className="py-8 px-4 sm:px-6 lg:px-8  min-h-screen">
      <div className=" p-6">
        ...
        <p className="text-lg text-center text-gray-600 mb-8">
          <strong>Date:</strong> July 20th 2026 - July 28th 2026
        </p>
        ...
        <div className="space-y-8">
          <section>
            <p className="text-gray-700 mt-2">
              ...
              16.45. Once on board we will check into our own cabins and get
              ready to settle in for the crossing that ends with us arriving at
          ...
          <section>
            <h2 className="text-2xl font-bold text-primary">Day 3 22/07/226</h2>
            ...
            <p className="text-gray-700 mt-2">
              ...
              St-Jean- Pied-de-Port, then back on the even twistier Col de
              Garzéla eventually returning back to Pamplona. We will all
              reconvene later at the same hotel as the previous night at Hotel
              Albert for a relaxing evening together as a group.
            </p>
          </section>
          <section>
            ...
            <p className="text-gray-700 mt-2">
              ...
              regardless of the national flags. It’s a full day of glorious
              gorges and passes, mostly on the Spanish side of the mountains ,
              with a short detour to the French side – but ask the locals and
              it’s all one country. On completion of this stunning loop it&apos;s
              time for a quick 180km ride over to Ainsa to our nights
              accommodation.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">
              We will depart Ainsa taking on some of the epic pass before
              heading towards Rippol with mile after mile of rolling roads and
              mountain roads before arriving at our evenings accommodation in
              Girona stopping at Hotel Costabella
            </p>
          </section>
          <section>
            <h2 className="text-2xl font-bold text-primary">
            ...
            <p className="text-gray-700 mt-2">
              Short blast from Girona to get us back on track for Today&apos;s ride
              over route 06 on our map.
            </p>
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">
              We will now start to clock up some miles as we start to wind our
              way back into Northern Spain stopping at the city of Zaragoza
            </p>
          </section>
          <section>
            <h2 className="text-2xl font-bold text-primary">
          ...
          <section>
            <p className="text-gray-700 mt-2">
              This amazing road trip is priced at £1979 per bike and rider, If
              you are traveling with a pillion there is an additional charge of
              £469. The trip includes your crossing both ways with Brittany
              Ferries. With your own cabin to allow you to get some sleep in
              privacy. 7 nights accommodation at the hotels stated above.
              Breakfast is included. But any other meals and drinks are at your
              own expense The trip is limited to 20 bikes and is classed as a
              self guided tour,with riders traveling routes and between A-B
              without a guide. The support vehicle can transport all your
              luggage from Portsmouth and back meaning you are able to ride your
              bike without luggage etc strapped to it. This has really worked
              well on our other tours.
            </p>
          </section>
          ...
          <section>
            ...
            <a
              href="https://buy.stripe.com/28odR7gFM9qQbIc4hP"
