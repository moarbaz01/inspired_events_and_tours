      ...
      <div className="space-y-8">
        <section>
          ...
          <p className="text-gray-700 mt-2">
            ...
            To catch the 11.20 Euro Tunnel to Calais. From experience from
        ...
        <section>
          ...
          <p className="text-gray-700 mt-2">
            ...
            our base for 2 nights near the historic town of Zell am See.
        ...
        <section>
          <p className="text-gray-700 mt-2">
            ...
            price per bike and includes a pillion is £1389 with your crossing
            both ways by Eurotunnel and the 7 nights hotel accommodation. Your
            accommodation will be double room to yourself unless traveling with
            a pillion, and includes breakfast evening food is not included but
            is available at the hotels or nearby restaurants..
          </p>
        </section>
        ...
        <section>
          <p className="text-gray-700 text-md mt-2 font-bold">
            Place can be reserved with a £389 deposit Simply click this link to
            pay your deposit
          </p>
          <a
