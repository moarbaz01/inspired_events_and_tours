    ...
    <div className="py-8 px-4 sm:px-6 lg:px-8  min-h-screen">
      ...
      <div className=" p-6">
        ...
        <p className="text-lg text-center text-gray-600 mb-8">
          <strong>Date:</strong> June 15th 2026 - June 22nd 2026
        </p>
        ...
        <section className="mt-12">
          ...
          <p className="text-gray-700 mt-2">
            ...
            unless traveling with a passenger, and includes breakfast but
            evening food is not included but is available at the hotels or
            nearby restaurants.. A deposit of <b>£489</b> is required to book
          ...
          <p className="mt-6 ">
            <a
              href="https://buy.stripe.com/00g7sJ89geLa3bGbKa"
              target="_blank"
