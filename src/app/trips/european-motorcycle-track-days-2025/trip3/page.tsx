      ...
      <div className="space-y-8">
        <section>
          <p className="text-gray-700 mt-2">
            We all meet at Folkestone at 11.30 am on September 17th and sort out
        ...
        <section>
          <p className="text-gray-700 mt-2">
            ...
            place with a £149 deposit paid by debit or credit card. Please let
            me know your thoughts Regards Ada
          </p>
        </section>
        ...
        <section>
          <p className="text-md font-bold">
            Place can be reserved with a £149 deposit Simply click this link to
            pay your deposit
          </p>
          <a
