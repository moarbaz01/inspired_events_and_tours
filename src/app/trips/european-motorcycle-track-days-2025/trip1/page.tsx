      ...
      <div className="space-y-8">
        <section>
          <p className="text-gray-700 mt-2">
            ...
            to Soissons rather than follow the support vehicle. A little boring
            at 70mph on a motorway. There are route options to Soissons, and
            most choose the more exciting route. We give you printed map
            ...
            selection of restaurants within a 5-minute walk. And a great Chinese
            buffet next door to the hotel that offers great food, and for £20
            you get all you can eat and 3 beers. This one seems to be most
            people&apos;s choice.
          </p>
        </section>
        ...
        <section>
          <p className="text-gray-700 mt-2">
            ...
            will be going out in groups so that everyone can get a feel for the
            circuit and pace they are comfortable with. There are never more
            than 20 bikes on track at any one time. Being a fairly long track,
            it means you will not be bunched up or feel intimidated. The best
            thing about the track day is it&apos;s an open pit, meaning you can
            go out as often as you like, unlike many track days.
          </p>
          <p className="text-gray-700 mt-2">
            There is a snack bar at the circuit with a selection of drinks and
            snacks on offer for you to purchase. The track day ends at 5 pm, and
            we then return to the hotel to freshen up. We try to all go into
            town as a group and have a few drinks and some food, talking about
            the day&apos;s highs and lows. This will mean getting some taxis,
        ...
        <section>
          <p className="text-gray-700 mt-2">
            ...
            their own way back for the crossing in groups they came with or with
            new groups of friends they have made on the trip. Our tickets are
            open for a return crossing any time on the 24th, but if you return
            at a different time on the day, there may be an admin charge payable
            to Eurotunnel. You are free to make your own way back if you wish or
            travel back as part of your own group or follow the support vehicle.
          </p>
          <p className="text-gray-700 mt-2">
        ...
        <section>
          <p className="text-gray-700 mt-2">
            ...
            Single occupancy rooms available at additional cost of <b>£80</b> or
            if traveling with a pillion the same additional cost applies. We
            hope you like the sound of this amazing trip and decide to join us.
            You can secure your place with a <b>£149</b> deposit paid by debit
            or credit card.
          </p>
